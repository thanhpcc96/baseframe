...
InstagramV1.Web.Challenge = require('./v1/web/Challenge')
InstagramV1.Web.NotImplementedChallenge = require('./v1/web/NotImplementedChallenge')
InstagramV1.Web.EmailVerificationChallenge = require('./v1/web/EmailVerificationChallenge')
InstagramV1.Web.PhoneVerificationChallenge = require('./v1/web/PhoneVerificationChallenge')
