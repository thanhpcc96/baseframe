...
Request.prototype.setSession = function setSession(session) {
...
Request.prototype.parseMiddleware = function parseMiddleware(response) {
...
Request.prototype.errorMiddleware = function errorMiddleware(response) {
  ...
  if (json.message === 'login_required') { throw new Exceptions.AuthenticationError(json, 'Login required to process this request') }
  if (json.errorType === 'sentry_block') { throw new Exceptions.SentryBlockError(json) }
  ...
  if (json.message.toLowerCase().indexOf('luminati.io') !== -1) { throw new Exceptions.RequestProxyError(json, this.session) }
  throw new Exceptions.RequestError(json, this.session)
}
