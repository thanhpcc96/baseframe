...
const ROUTES = {
  ...
  locationsSearch: 'fbsearch/places/?count=30&query=<%= encodeURIComponent(query) %>&rank_token=<%= rankToken %>',
  ...
  // smartgram
  feedUserStory: 'feed/user/<%= userId %>/story/',
  discoverProfileSuBadge: 'discover/profile_su_badge/',
